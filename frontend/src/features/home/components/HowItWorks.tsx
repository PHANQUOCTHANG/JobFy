...
export function HowItWorks() {
  return (
    <section className="py-20 px-5 lg:px-10 bg-slate-50/50 border-t border-slate-100">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          <div className="hidden md:block absolute top-1/2 left-10 right-10 h-px bg-gradient-to-r from-transparent via-[#F59E0B]/50 to-transparent -translate-y-1/2 z-0" />
          ...
          {[
            ...
            <Reveal key={step} delay={i * 100} className="relative z-10">
              <div className="bg-white rounded-2xl p-8 text-center shadow-lg border border-[#E2E8F0] hover:-translate-y-2 transition-transform duration-300">
                ...
                <h3 className="font-bold text-[18px] text-[#0F172A] mb-3" style={{ fontFamily: "'Manrope', sans-serif" }}>{title}</h3>
