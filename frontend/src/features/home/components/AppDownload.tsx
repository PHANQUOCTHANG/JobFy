  ...
  return (
    <section className="py-20 px-5 lg:px-10 bg-[#F7F4EE]">
      <div className="max-w-7xl mx-auto">
        <div className="bg-[#111018] rounded-[2.5rem] relative overflow-hidden flex flex-col lg:flex-row items-center justify-between p-10 lg:p-20 shadow-2xl">
          
          {/* Left Content */}
          <div className="lg:w-1/2 relative z-10">
            <Reveal>
              <div className="inline-flex items-center gap-2 border border-[#E8A83A]/30 text-[#E8A83A] text-[12px] font-bold px-3.5 py-1.5 rounded-lg mb-8">
                <Smartphone size={14} /> Ứng dụng di động
              </div>
              <h2 className="text-[3rem] lg:text-[4rem] font-black text-white leading-[1.05] mb-6 tracking-tight" style={{ fontFamily: "'Playfair Display', serif" }}>
                Tìm việc mọi lúc,<br />
                <span className="text-[#E8A83A]">mọi nơi.</span>
              </h2>
              <p className="text-[#6B6059] text-[17px] leading-relaxed mb-10 max-w-[400px]">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                <button className="flex items-center justify-center gap-3 border border-white/20 hover:border-white/40 bg-transparent text-white px-6 py-3.5 rounded-2xl transition-all w-full sm:w-auto">
                  ...
                  <div className="text-left">
                    <p className="text-[10px] text-[#9B8E7F]">Tải trên</p>
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center">
                  {["#D44E2B", "#E8A83A", "#10B981", "#7C3AED", "#3B82F6"].map((color, i) => (
                    <div key={i} className="w-9 h-9 rounded-full border-2 border-[#111018] -ml-3 first:ml-0" style={{ backgroundColor: color }} />
                  ))}
                </div>
                <div>
                  <div className="flex gap-1 mb-0.5">
                    {[1, 2, 3, 4, 5].map(s => <span key={s} className="text-[#E8A83A] text-xs">★</span>)}
                  </div>
                  <p className="text-[12px] text-[#6B6059] font-medium">500K+ lượt tải - 4.9⭐</p>
                </div>
              </div>
            </Reveal>
          </div>
            ...
            <Reveal delay={150}>
              <div className="relative w-[320px] h-[640px] bg-[#1C1926] rounded-[3rem] border-[8px] border-[#221A2C] shadow-2xl p-6 flex flex-col">
                ...
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <span className="text-[16px] font-black text-white" style={{ fontFamily: "'Playfair Display', serif" }}>
                ...
                <div className="bg-transparent border border-white/20 rounded-2xl p-3.5 mb-6 flex items-center gap-2">
                  <span className="text-[#6B6059]">🔍</span>
                  <span className="text-[#6B6059] text-[13px]">Tìm công việc...</span>
                </div>

                {/* Job Cards */}
                <div className="space-y-4">
                  <div className="border border-white/20 rounded-2xl p-4 flex items-center gap-3">
                    <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-[#111018] font-bold text-xs">FPT</div>
                    <div className="flex-1">
                      <p className="text-white font-bold text-[13px]">Senior React Dev</p>
                      <p className="text-[#6B6059] text-[11px]">FPT Software</p>
                    </div>
                    <p className="text-[#E8A83A] font-bold text-[12px]">25-40M</p>
                  </div>
                  <div className="border border-white/20 rounded-2xl p-4 flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[#6B6059] text-[11px]">Tiki</p>
                    </div>
                    <p className="text-[#E8A83A] font-bold text-[12px]">18-28M</p>
                  </div>
                  <div className="border border-white/20 rounded-2xl p-4 flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[#6B6059] text-[11px]">Grab</p>
                    </div>
                    <p className="text-[#E8A83A] font-bold text-[12px]">18-32M</p>
                  </div>
                </div>

                {/* AI Match Card */}
                <div className="mt-auto bg-gradient-to-r from-[#3A2218] to-[#2B1B15] border border-[#D44E2B]/30 rounded-2xl p-5">
                  <p className="text-[#E8A83A] font-bold text-[13px] flex items-center gap-1.5 mb-4">
                    ✨ AI Match mới!
                  </p>
                  <div className="h-1.5 bg-black/50 rounded-full mb-3">
                    <div className="h-1.5 bg-[#E8A83A] rounded-full w-[80%]" />
                  </div>
                  <p className="text-[#9B8E7F] text-[11px]">80% phù hợp • 12 việc mới</p>
                </div>
                ...
                <div className="absolute top-[35%] -left-16 bg-white rounded-2xl p-3 shadow-2xl flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[#111018] font-bold text-[12px]">Lời mời phỏng vấn!</p>
                    <p className="text-[#6B6059] text-[10px]">Grab • vừa xong</p>
                  </div>
                </div>
              </div>
            </Reveal>
