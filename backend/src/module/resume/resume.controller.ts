...
export const addEducation = asyncHandler(async (req: Request, res: Response) => {
  const data = await resumeService.addEducation((req.params.id as string), req.user!.id, req.body);
...
export const addExperience = asyncHandler(async (req: Request, res: Response) => {
  const data = await resumeService.addExperience((req.params.id as string), req.user!.id, req.body);
...
export const addSkill = asyncHandler(async (req: Request, res: Response) => {
  const data = await resumeService.addSkill(req.params.id as string, req.user!.id, req.body);
...
export const updateSkill = asyncHandler(async (req: Request, res: Response) => {
  const data = await resumeService.updateSkill(req.params.id as string, Number(req.params.nestedId), req.user!.id, req.body);
...
export const deleteSkill = asyncHandler(async (req: Request, res: Response) => {
  await resumeService.deleteSkill(req.params.id as string, Number(req.params.nestedId), req.user!.id);
...
export const addCertification = asyncHandler(async (req: Request, res: Response) => {
  const data = await resumeService.addCertification(req.params.id as string, req.user!.id, req.body);
...
export const updateCertification = asyncHandler(async (req: Request, res: Response) => {
  const data = await resumeService.updateCertification(req.params.id as string, Number(req.params.nestedId), req.user!.id, req.body);
...
export const deleteCertification = asyncHandler(async (req: Request, res: Response) => {
  await resumeService.deleteCertification(req.params.id as string, Number(req.params.nestedId), req.user!.id);
...
export const addProject = asyncHandler(async (req: Request, res: Response) => {
  const data = await resumeService.addProject(req.params.id as string, req.user!.id, req.body);
  return res.status(201).json(ApiResponse.success(data, "Đã thêm dự án"));
});

export const updateProject = asyncHandler(async (req: Request, res: Response) => {
  const data = await resumeService.updateProject(req.params.id as string, Number(req.params.nestedId), req.user!.id, req.body);
  return res.status(200).json(ApiResponse.success(data, "Đã cập nhật dự án"));
});

export const deleteProject = asyncHandler(async (req: Request, res: Response) => {
  await resumeService.deleteProject(req.params.id as string, Number(req.params.nestedId), req.user!.id);
